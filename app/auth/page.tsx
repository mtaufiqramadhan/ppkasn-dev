...
const BrandSection = React.memo(() => (
    <div className="hidden sm:block absolute bottom-12 left-6 sm:bottom-12 sm:left-12 text-white drop-shadow-lg max-w-[90%] sm:max-w-md">
...
const LoginCard = React.memo(({ className }: { className?: string }) => (
    <Card className={cn(
        "w-full max-w-sm sm:max-w-md shadow-xl rounded-3xl",
