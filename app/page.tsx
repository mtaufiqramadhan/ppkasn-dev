...
export default function MeetingRoomPage() {
  ...
  const { rooms, bookings, refresh } = useCalendarData(
    year,
    month
  );
  ...
  const visibleRoomIds = useMemo(() => new Set(rooms.map((r) => r.id)), [rooms]);
  ...
  return (
    <div className="flex flex-col min-h-screen gap-4 bg-white p-4 w-full max-w-7xl mx-auto">
